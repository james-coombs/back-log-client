...
/***/ function(module, exports, __webpack_require__) {
	...
	var kCode = __webpack_require__(34);
	var appUi = __webpack_require__(35);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onDeleteLogById = function onDeleteLogById(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	...
	var onSelectLog = function onSelectLog(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.selectLog(data).done(ui.getLogByIdSuccess).fail(ui.getLogByIdFailure);
	};
	...
	module.exports = {
	  ...
	  onDeleteLogById: onDeleteLogById,
