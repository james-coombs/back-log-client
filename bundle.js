...
/***/ function(module, exports, __webpack_require__) {
	...
	var kCode = __webpack_require__(35);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onSignInUser = function onSignInUser(event) {
	  event.preventDefault();
	  api.signInUser(event.target).done(ui.signInSuccess).fail(ui.signInFailure);
	};
	...
	var onSignOutUser = function onSignOutUser() {
	  ...
	  api.signOutUser().done(ui.signOutUserSuccess).fail(ui.signOutUserError);
	};

	var userAddHandlers = function userAddHandlers() {
	...
	module.exports = {
	  userAddHandlers: userAddHandlers,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var signOutUserError = function signOutUserError() {
	...
	module.exports = {
	  ...
	  signOutUserError: signOutUserError
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onUpdateLog = function onUpdateLog(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.updateLog(data).done(ui.updateLogSuccess).fail(ui.updateLogfailure);
	};

	var callUpdateTemplate = function callUpdateTemplate() {
	  var data = this.id;
	  api.getLog(data).done(ui.renderUpdateTemplate).fail(ui.getLogByIdFailure);
	};

	var onDeleteLog = function onDeleteLog() {
	  var data = this.id;
	  $('.info').text('Deleted Log');
	  api.deleteLogById(data).done(ui.deleteLogByIdSuccess).fail(ui.deleteLogByIdfailure);
	};

	var onShowLog = function onShowLog() {
	  var data = this.id;
	  $('.info').text('Here\'s your Log:');
	  api.getLog(data).done(ui.getLogSuccess).fail(ui.getLogByIdFailure);
	};

	var onGetLogs = function onGetLogs() {
	  event.preventDefault();
	  api.getLogs().done(ui.getLogsSuccess).fail(ui.getLogsFailure);
	};

	var onGetLogsHistory = function onGetLogsHistory() {
	  api.getLogs().done(ui.getLogsHistorySuccess).fail(ui.getLogsFailure);
	};
	...
	module.exports = {
	  logAddHandlers: logAddHandlers,
	  onCreateLog: onCreateLog,
	  onUpdateLog: onUpdateLog,
	  onDeleteLog: onDeleteLog,
	  onGetLogs: onGetLogs,
	  onShowLog: onShowLog,
	  callUpdateTemplate: callUpdateTemplate
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var updateLog = function updateLog(data) {
	  return $.ajax({
	...
	var selectLog = function selectLog(data) {
	  return $.ajax({
	...
	var getLog = function getLog(data) {
	  return $.ajax({
	...
	var getLogsHistory = function getLogsHistory() {
	  return $.ajax({
	    url: app.host + '/logs',
	    method: 'GET',
	    headers: {
	...
	var deleteLogById = function deleteLogById(data) {
	  return $.ajax({
	    url: app.host + '/logs/' + data,
	    method: 'DELETE',
	    headers: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var showLogs = __webpack_require__(12);

	var showLogsHistory = __webpack_require__(32);

	var displayLog = __webpack_require__(33);

	var updateLog = __webpack_require__(34);
	...
	var getLogsHistorySuccess = function getLogsHistorySuccess(data) {
	  app.log = data.logs;
	  isDataEmpty(data);
	  $('.hbs-content').html(showLogsHistory(data));
	};

	var getLogSuccess = function getLogSuccess(data) {
	  app.log = data.log;
	  isDataEmpty(data);
	  var log = data.log;
	  var hbsObject = {};
	...
	var getLogsFailure = function getLogsFailure() {
	...
	module.exports = {
	  ...
	  deleteLogByIdSuccess: deleteLogByIdSuccess,
	  createLogfailure: createLogfailure,
	  getLogsSuccess: getLogsSuccess,
	  getLogsHistorySuccess: getLogsHistorySuccess,
	  getLogByIdSuccess: getLogByIdSuccess,
	  updateLogfailure: updateLogfailure,
	  deleteLogByIdfailure: deleteLogByIdfailure,
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "    <div class=\"row\">\n      <div class=\"col-sm-2\">\n        <h6>"
	    ...
	    + "</h6>\n      </div>\n      <div class=\"col-sm-2\">\n        <button class=\"full-width delete-log\" id=\""
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + "\" data-control=\"deleteLog\">Delete</button>\n        <br>\n        <button class=\"full-width show-log\" id=\""
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + "\" data-control=\"showLog\">Show</button>\n        <br>\n        <button class=\"full-width update-log\" id=\""
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + "\" data-control=\"updateLog\">Update</button>\n      </div>\n      </div>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return "<div class=\"col-sm-12 back-logs-table\">\n  <div>\n"
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div class=\"col-sm-12 back-logs-table\">\n  <div>\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.log : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "  </div>\n</div>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "          <div class=\"row\">\n            <div class=\"col-sm-2\">\n              <h6>"
	    ...
	    + "</h6>\n            </div>\n            <div class=\"col-sm-2\">\n              <h6>"
	    + alias4(((helper = (helper = helpers.platform || (depth0 != null ? depth0.platform : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"platform","hash":{},"data":data}) : helper)))
	    + "</h6>\n            </div>\n            <div class=\"col-sm-2\">\n              <input class=\"log-update-text\" name=\"log[players]\" type=\"text\" value=\""
	    + alias4(((helper = (helper = helpers.players || (depth0 != null ? depth0.players : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"players","hash":{},"data":data}) : helper)))
	    + "\" placeholder=\""
	    + alias4(((helper = (helper = helpers.players || (depth0 != null ? depth0.players : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"players","hash":{},"data":data}) : helper)))
	    + "\">\n            </div>\n            <div class=\"col-sm-2\">\n              <input class=\"log-update-text\" name=\"log[stage]\" type=\"text\" value=\""
	    + alias4(((helper = (helper = helpers.stage || (depth0 != null ? depth0.stage : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"stage","hash":{},"data":data}) : helper)))
	    + "\" placeholder=\""
	    + alias4(((helper = (helper = helpers.stage || (depth0 != null ? depth0.stage : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"stage","hash":{},"data":data}) : helper)))
	    + "\">\n            </div>\n            <div class=\"col-sm-2\">\n              <input class=\"log-update-text\" name=\"log[notes]\" type=\"text\" value=\""
	    + alias4(((helper = (helper = helpers.notes || (depth0 != null ? depth0.notes : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"notes","hash":{},"data":data}) : helper)))
	    + "\" placeholder=\""
	    + alias4(((helper = (helper = helpers.notes || (depth0 != null ? depth0.notes : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"notes","hash":{},"data":data}) : helper)))
	    + "\">\n            </div>\n            <div class=\"col-sm-2\">\n              <input type=\"Submit\" class=\"back-log-button\" value=\"Update Log\">\n              <br>\n              <button class=\"delete-log\" id=\""
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + "\" data-control=\"deleteLog\">Delete</button>\n            </div>\n          </div>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var activateKcode = function activateKcode() {
	...
	var kCodeHandler = function kCodeHandler() {
	  activateKcode();
	};

	module.exports = {
	  kCodeHandler: kCodeHandler
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var wellControlHandler = function wellControlHandler() {
	  $('.well-toggle').on('click', function () {
	    $('.well').closest(".accordion").find(".collapse.in").not(this).collapse('toggle');
	  });
	};

	module.exports = {
	  wellControlHandler: wellControlHandler
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
